...
<!-- ++++++++++++++++++++ Start Main Content of the page here! +++++++++++++++++++++ -->
        ...
        <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
            <img src='<?php echo $figures;?>/ATLAS/fig_195a.png' width='40%'>
            <img src='<?php echo $figures;?>/ATLAS/fig_195b.png' width='40%'>
        </div>
        </br>
        ...
        <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
            <img src='<?php echo $figures;?>/ATLAS/prm.png' width='48%'>
            <img src='<?php echo $figures;?>/ATLAS/PRM_diagram.png' width='42%'>
        </div>
        </br>
        <p style="object-fit: caution;  flex-grow: 1; text-align: center;">
        ...
        <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
            <img src='<?php echo $figures;?>/ATLAS/am08.jpg' width='58%'>
            <img src='<?php echo $figures;?>/ATLAS/probe_card.jpg' width='31%'>
        </div>
        </br>
        <p style="object-fit: caution;  flex-grow: 1; text-align: center;">
