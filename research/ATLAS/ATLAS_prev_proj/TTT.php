...
Our ATLAS group at the Physikalisches Institut is invovled in studying a new concept of a track based trigger for the future hadron collider experiments.
        </p>
        </br>
...
Higher √s and luminosity of the proton beams will not only make di-Higgs production more accessible but also give insigts on the nature or the shape of the Higgs potential (weather it is a mexican hat potential as in the case of the Standard Model or not).
A feasibility study with a triggerless readout, negligible pile-up and systematic uncertainties for FCC-hh shows that λ can be measured with a precision of 5% using the HH->4b decay channel.
        ...
        <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
            <img src='<?php echo $figures;?>/ATLAS/Lambda.png' width='40%'>
            <img src='<?php echo $figures;?>/ATLAS/HiggsPotential.png' width='26%'>
        </div>
        </br>
        <p style="object-fit: caution;  flex-grow: 1; text-align: center;">
...
However, readout bandwidth and latency requirement have prevented the use of track based triggers at the very first level.
        </p>
        </br>
        <div style="text-align: center;">
...
We are also designing a chip that performs the Triplet Track Trigger algorithm to reconstruct particle tracks in the detector in real time with as little latency as possible.
            ...
            <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
            <img src='<?php echo $figures;?>/ATLAS/a_withBML_1.png' style="width: 25%;" alt="Tracking detector">
            <img src='<?php echo $figures;?>/ATLAS/b_2.png' style="width: 25%;" alt="Track Reconstruction Event">
            <img src='<?php echo $figures;?>/ATLAS/ATLAS_G4_2.png' style="width: 50%;" alt="Track Reconstruction Event">
            </div>
            </br>
        <div style="text-align: center;">
            <p style="object-fit: caution; flex-grow: 1; text-align: center;">
